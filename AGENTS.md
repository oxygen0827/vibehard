...
- Active production platform and Gateway release: `/opt/vibehard/releases/20260918-cloud-runner`. The default `cloud-runner` is live; do not replace or rotate its credential unless intentionally re-registering it and immediately verifying a fresh heartbeat.
