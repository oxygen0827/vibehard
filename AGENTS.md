...
- Active platform release: `/opt/vibehard/releases/20260919-design-knowledge-pricing`; active Gateway release: `/opt/vibehard/releases/20260918-cloud-runner`. Read `docs/current-status.md` for live model evidence; do not infer availability from a stored Runner status. Do not replace or rotate the `cloud-runner` credential unless intentionally re-registering it and immediately verifying a fresh heartbeat.
